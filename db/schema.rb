...
ActiveRecord::Schema[7.2].define(version: 2024_10_10_132409) do
  ...
  create_table "total_monthly_fees", force: :cascade do |t|
    t.string "merchant_reference", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["merchant_reference"], name: "index_total_monthly_fees_on_merchant_reference"
  end
end
